...
describe("Sudoku circuit", function () {
  ...
  before(async function () {
    sudokuCircuit = await wasm_tester("zkSudoku/sudoku.circom");
  });
  ...
  it("Should fail as there are out of bounds values", async function () {
    let input = {
      unsolved: [
        [0, 0, 0, 0, 0, 6, 0, 0, 0],
        [0, 0, 7, 2, 0, 0, 8, 0, 0],
    ...
    it("Should fail as initial state of solved is not the unsolved", async function (){
        let input= {
            unsolved: [
        [0, 0, 0, 0, 0, 6, 0, 0, 0],
        [0, 0, 7, 2, 0, 0, 8, 0, 0],
