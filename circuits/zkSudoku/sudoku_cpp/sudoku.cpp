...
uint get_size_of_witness() {return 7858;}
...
{
uint aux_create = 0;
int aux_cmp_num = 1863+ctx_index+1;
uint csoffset = mySignalStart+5751;
uint aux_dimensions[2] = {9,9};
for (uint i = 0; i < 81; i++) {
std::string new_cmp_name = "checknine"+ctx->generate_position_array(aux_dimensions, 2, i);
...
uint aux_dimensions[2] = {9,9};
for (uint i = 0; i < 81; i++) {
std::string new_cmp_name = "checkone"+ctx->generate_position_array(aux_dimensions, 2, i);
...
{
uint aux_create = 162;
int aux_cmp_num = 1782+ctx_index+1;
uint csoffset = mySignalStart+5508;
uint aux_dimensions[2] = {9,9};
for (uint i = 0; i < 81; i++) {
std::string new_cmp_name = "checkZero"+ctx->generate_position_array(aux_dimensions, 2, i);
...
uint csoffset = mySignalStart+2106;
uint aux_dimensions[2] = {9,9};
for (uint i = 0; i < 81; i++) {
std::string new_cmp_name = "checkEqual"+ctx->generate_position_array(aux_dimensions, 2, i);
...
uint csoffset = mySignalStart+2592;
...
{
uint aux_create = 972;
int aux_cmp_num = 1458+ctx_index+1;
...
std::string new_cmp_name = "checkSquare"+ctx->generate_position_array(aux_dimensions, 1, i);
IsEqual_5_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+ i] = aux_cmp_num;
csoffset += 6 ;
aux_cmp_num += 2;
...
Fr_lt(&expaux[0],&lvar[0],&circuitConstants[5]); // line circom 14
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[1];
// load src
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[5]); // line circom 15
while(Fr_isTrue(&expaux[0])){
{
...
cmp_index_ref_load = (((9 * Fr_toInt(&lvar[0])) + (1 * Fr_toInt(&lvar[1]))) + 0);
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[(((9 * Fr_toInt(&lvar[0])) + (1 * Fr_toInt(&lvar[1]))) + 0)]].signalStart + 0],&circuitConstants[2]); // line circom 19
}}
...
cmp_index_ref_load = (((9 * Fr_toInt(&lvar[0])) + (1 * Fr_toInt(&lvar[1]))) + 81);
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[(((9 * Fr_toInt(&lvar[0])) + (1 * Fr_toInt(&lvar[1]))) + 81)]].signalStart + 0],&circuitConstants[2]); // line circom 24
}}
...
Fr_lt(&expaux[0],&lvar[0],&circuitConstants[5]); // line circom 33
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[1];
// load src
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[5]); // line circom 34
while(Fr_isTrue(&expaux[0])){
{
...
cmp_index_ref_load = (((9 * Fr_toInt(&lvar[0])) + (1 * Fr_toInt(&lvar[1]))) + 162);
Fr_sub(&expaux[1],&circuitConstants[2],&ctx->signalValues[ctx->componentMemory[mySubcomponents[(((9 * Fr_toInt(&lvar[0])) + (1 * Fr_toInt(&lvar[1]))) + 162)]].signalStart + 0]); // line circom 41
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[(((9 * Fr_toInt(&lvar[0])) + (1 * Fr_toInt(&lvar[1]))) + 243)]].signalStart + 0],&expaux[1]); // line circom 41
}}
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[5]); // line circom 49
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[3];
// load src
...
Fr_lt(&expaux[0],&lvar[3],&circuitConstants[5]); // line circom 50
while(Fr_isTrue(&expaux[0])){
{
...
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[0])) + 324);
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[0])) + 324)]].signalStart + 0],&circuitConstants[1]); // line circom 54
}}
...
PFrElement aux_dest = &lvar[3];
// load src
Fr_add(&expaux[0],&lvar[3],&circuitConstants[2]); // line circom 50
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[3],&circuitConstants[5]); // line circom 50
...
Fr_lt(&expaux[0],&lvar[3],&circuitConstants[5]); // line circom 64
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[4];
// load src
Fr_add(&expaux[0],&lvar[3],&circuitConstants[2]); // line circom 65
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[4],&circuitConstants[5]); // line circom 65
while(Fr_isTrue(&expaux[0])){
{
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((9 * Fr_toInt(&lvar[3])) + (1 * Fr_toInt(&lvar[2]))) + 81)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
IsEqual_5_run(mySubcomponents[cmp_index_ref],ctx);
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((9 * Fr_toInt(&lvar[4])) + (1 * Fr_toInt(&lvar[2]))) + 81)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
IsEqual_5_run(mySubcomponents[cmp_index_ref],ctx);
...
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[1])) + 648);
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[1])) + 648)]].signalStart + 0],&circuitConstants[1]); // line circom 69
}}
...
PFrElement aux_dest = &lvar[1];
// load src
Fr_add(&expaux[0],&lvar[1],&circuitConstants[2]); // line circom 70
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &lvar[4];
// load src
Fr_add(&expaux[0],&lvar[4],&circuitConstants[2]); // line circom 65
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[4],&circuitConstants[5]); // line circom 65
...
Fr_lt(&expaux[0],&lvar[3],&circuitConstants[5]); // line circom 78
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[4];
// load src
...
Fr_add(&expaux[1],&lvar[3],&circuitConstants[6]); // line circom 80
Fr_lt(&expaux[0],&lvar[5],&expaux[1]); // line circom 80
while(Fr_isTrue(&expaux[0])){
{
...
Fr_add(&expaux[1],&lvar[4],&circuitConstants[6]); // line circom 81
Fr_lt(&expaux[0],&lvar[6],&expaux[1]); // line circom 81
while(Fr_isTrue(&expaux[0])){
{
...
Fr_leq(&expaux[0],&lvar[7],&lvar[5]); // line circom 82
while(Fr_isTrue(&expaux[0])){
{
...
Fr_lt(&expaux[0],&lvar[8],&lvar[6]); // line circom 83
while(Fr_isTrue(&expaux[0])){
{
...
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[2])) + 972);
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[2])) + 972)]].signalStart + 0],&circuitConstants[1]); // line circom 87
}}
...
PFrElement aux_dest = &lvar[2];
// load src
Fr_add(&expaux[0],&lvar[2],&circuitConstants[2]); // line circom 88
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &lvar[8];
// load src
Fr_add(&expaux[0],&lvar[8],&circuitConstants[2]); // line circom 83
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[8],&lvar[6]); // line circom 83
...
PFrElement aux_dest = &lvar[7];
// load src
Fr_add(&expaux[0],&lvar[7],&circuitConstants[2]); // line circom 82
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_leq(&expaux[0],&lvar[7],&lvar[5]); // line circom 82
...
PFrElement aux_dest = &lvar[6];
// load src
Fr_add(&expaux[0],&lvar[6],&circuitConstants[2]); // line circom 81
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_add(&expaux[1],&lvar[4],&circuitConstants[6]); // line circom 81
...
PFrElement aux_dest = &lvar[5];
// load src
Fr_add(&expaux[0],&lvar[5],&circuitConstants[2]); // line circom 80
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_add(&expaux[1],&lvar[3],&circuitConstants[6]); // line circom 80
...
PFrElement aux_dest = &lvar[4];
// load src
Fr_add(&expaux[0],&lvar[4],&circuitConstants[6]); // line circom 79
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[4],&circuitConstants[5]); // line circom 79
...
PFrElement aux_dest = &lvar[3];
// load src
Fr_add(&expaux[0],&lvar[3],&circuitConstants[6]); // line circom 78
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[3],&circuitConstants[5]); // line circom 78
